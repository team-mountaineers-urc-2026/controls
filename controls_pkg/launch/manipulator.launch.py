...
def generate_launch_description():
    ...
    wrist_pitch_id  = DeclareLaunchArgument(name = 'wrist_pitch_id',    default_value = f'{int(0x148)}',    description = 'Motor ID for Wrist Pitch Motor in Base 10')
    ...
    can_network_id  = DeclareLaunchArgument(name = 'can_network_id',    default_value = 'can1',             description = 'What network are you using?')
